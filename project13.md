### ref: https://github.com/ojoimmanuel/ansible-config-mgt.git
...
![apache-lb](./images/15-apache-lb.PNG)

![nginx-lb](./images/16-nginx-lb.PNG)

![site](./images/18-site-lb.PNG)
